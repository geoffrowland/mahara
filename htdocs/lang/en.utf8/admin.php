...
$string['usedefaultdescription2'] = 'If set to "On", use the site\'s default text for the selected page type.';
...
$string['mathjaxdescription'] = 'MathJax enables mathematics and science equations to be displayed';
...
$string['updategroupsdescription1'] = 'If set to "On", the information in the CSV file will overwrite any details of groups whose group shortname is in the CSV file. Use with care.';
